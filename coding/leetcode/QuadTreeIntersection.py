...
class Solution:
    def intersect(self, quadTree1: 'Node', quadTree2: 'Node') -> 'Node':        
        # same as solution below but not inplace
        # less code, more succint
        if quadTree1.isLeaf:
    ...
    def intersect1(self, quadTree1: 'Node', quadTree2: 'Node') -> 'Node':
        # atually looking for union/OR
        # inplace solution
        ...
        if quadTree1.isLeaf and quadTree2.isLeaf:
            ...
            # if all subtrees are lead node, check for merge condition
            if topLeft.isLeaf and topRight.isLeaf and bottomLeft.isLeaf and bottomRight.isLeaf:
                ...
                # all true
                if not (topLeft.val or topRight.val or bottomLeft.val or bottomRight.val):
                    quadTree1.isLeaf = True
                    quadTree1.val = False
                    quadTree1.topLeft = None
                    quadTree1.topRight = None
